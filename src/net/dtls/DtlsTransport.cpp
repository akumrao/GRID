...
void DtlsTransport::CreateSslCtx() { return; }
...
inline bool DtlsTransport::CheckRemoteFingerprint() { return true; }
...
//        int DtlsTransport::ReadCallback(void *ctx, unsigned char *buf, size_t
//        len) {
...
//
//
//    int DtlsTransport::WriteCallback(void *ctx, const unsigned char *buf,
//    size_t len) {
//	auto *t = static_cast<DtlsTransport *>(ctx);
//	try {
//		if (len > 0) {
...
//    void DtlsTransport::SetTimerCallback(void *ctx, uint32_t int_ms, uint32_t
//    fin_ms) {
...
//            return -1;
//        } else if (now >= dtlsTransport->mTimerSetAt +
//        std::chrono::milliseconds(dtlsTransport->mFinMs)) {
//            return 2;
//        } else if (now >= dtlsTransport->mTimerSetAt +
//        std::chrono::milliseconds(dtlsTransport->mIntMs)) {
//            return 1;
//        } else {
//            return 0;
//        }
...
//	std::map<std::string, DtlsTransport::FingerprintAlgorithm>
...
//	};
//	std::map<DtlsTransport::FingerprintAlgorithm, std::string>
...
//
//		file =
// fopen(Settings::configuration.dtlsCertificateFile.c_str(), "r");
//
//		if (!file)
//		{
//			LError("error reading DTLS certificate file: ",
// std::strerror(errno));
//
//			goto error;
//		}
//
//		DtlsTransport::certificate = PEM_read_X509(file, nullptr,
// nullptr, nullptr);
//
//		if (!DtlsTransport::certificate)
//		{
...
//		fclose(file);
//
//		file = fopen(Settings::configuration.dtlsPrivateKeyFile.c_str(),
//"r");
//
//		if (!file)
//		{
//			LError("error reading DTLS private key file: ",
// std::strerror(errno));
//
//			goto error;
//		}
//
//		DtlsTransport::privateKey = PEM_read_PrivateKey(file, nullptr,
// nullptr, nullptr);
//
//		if (!DtlsTransport::privateKey)
//		{
...
//	error:
//
//		base::uv::throwError("error reading DTLS certificate and private
// key PEM files");
//	}
...
#error "too old OpenSSL version"
  ...
  //                else
  //                {
  //                    if (SSL_CTX_load_verify_locations(DtlsTransport::sslCtx,
  //                    Settings::configuration.dtlsCertificateFile.c_str(),
  //                    nullptr) != 1)
  //                            ERR_print_errors_fp(stderr);
  //
  //                    if
  //                    (SSL_CTX_set_default_verify_paths(DtlsTransport::sslCtx)
  //                    != 1)
  //                            ERR_print_errors_fp(stderr);
  //
  //                            /* set the local certificate from CertFile */
  //                    if (SSL_CTX_use_certificate_file(DtlsTransport::sslCtx,
  //                    Settings::configuration.dtlsCertificateFile.c_str(),
  //                    SSL_FILETYPE_PEM) <= 0) {
  //                        ERR_print_errors_fp(stderr);
  //                        abort();
  ...
  //
  //
  //                    SSL_CTX_set_default_passwd_cb_userdata(DtlsTransport::sslCtx,
  //                    (void *) "12345678");
  //
  //                    if (SSL_CTX_use_PrivateKey_file(DtlsTransport::sslCtx,
