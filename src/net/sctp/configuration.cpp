...
IceServer_conf::IceServer_conf(const string &url) {
...
IceServer_conf::IceServer_conf(string hostname_, uint16_t port_)
    : hostname(std::move(hostname_)), port(port_), type(Type::Stun) {}

IceServer_conf::IceServer_conf(string hostname_, string service_)
...
IceServer_conf::IceServer_conf(string hostname_, uint16_t port_, string username_, string password_,
...
IceServer_conf::IceServer_conf(string hostname_, string service_, string username_, string password_,
                     RelayType relayType_)
