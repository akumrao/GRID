...
namespace stun {
   ...
   */
  int  Writer::writeMessage(MessageStun* msg, std::string messageIntegrityPassword) {
   ...
   */
  int Writer::writeMessage(MessageStun* msg) {
...
//    writeU32(msg->transaction[2]); /* transaction */
  ...
  void Writer::writeAttribute(Attribute* attr , MessageStun* msg) {
 ...
 void Writer::writeXorMappedAddress(XorMappedAddress* xma, MessageStun* msg) {
