...
int Screencapture::captureVideoFrames()
{
	int flag;
...
*/
	...
	pAVInputFormat = av_find_input_format("x11grab");
  	value = avformat_open_input(&pAVFormatContext, ":1.0+10,250", pAVInputFormat, NULL);
	if(value != 0)
	{
...
int Screencapture::init_outputfile()
{
